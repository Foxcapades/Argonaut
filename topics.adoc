...
The following is an example command construction of the CLI API for the command
`cat` which has a slightly complicated API due to some flags being shortcuts for
