...
// Octal represents an untyped signed int value that is expected to be input in
// octal notation and will be parsed from string in base 8.
type Octal int
...
// Octal8 represents a signed 8 bit int value that is expected to be input in
// octal notation and will be parsed from string in base 8.
type Octal8 int8
...
// Octal16 represents a signed 16 bit int value that is expected to be input in
// octal notation and will be parsed from string in base 8.
type Octal16 int16
...
// Octal32 represents a signed 32 bit int value that is expected to be input in
// octal notation and will be parsed from string in base 8.
type Octal32 int32
...
// Octal64 represents a signed 64 bit int value that is expected to be input in
// octal notation and will be parsed from string in base 8.
type Octal64 int64
