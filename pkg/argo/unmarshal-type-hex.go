...
// Hex represents an untyped signed int value that is expected to be input in
...
// Hex8 represents a signed 8 bit int value that is expected to be input in
// hexadecimal notation and will be parsed from string in base 16.
type Hex8 int8
...
// Hex16 represents a signed 16 bit int value that is expected to be input in
// hexadecimal notation and will be parsed from string in base 16.
type Hex16 int16
...
// Hex32 represents a signed 32 bit int value that is expected to be input in
// hexadecimal notation and will be parsed from string in base 16.
type Hex32 int32
