...
type LeafCommandBuilder interface {
	...
	// LeafCommandBuilder's list of positional arguments.
	WithArgument(arg ArgumentBuilder) LeafCommandBuilder

	// WithArguments appends the given ArgumentBuilder instances to this
	// LeafCommandBuilder's list of positional arguments.
	WithArguments(args ...ArgumentBuilder) LeafCommandBuilder

	// HasArguments indicates whether any positional arguments have been set on
	// this LeafCommandBuilder instance.
	HasArguments() bool

	// Arguments returns a slice containing the ArgumentBuilders that have been
	// set on this LeafCommandBuilder instance.
