...
type TypedArgumentSpecBuilder[T any] interface {
	...
	//
	// Validators are called in the order they are added to the ArgumentSpecBuilder.
	WithPostValidator(validator PostParseArgumentValidator) TypedArgumentSpecBuilder[T]
	...
	// WithBinding adds a pointer binding to this ArgumentSpecBuilder which will be
	// filled with the parsed value after it has been validated.
