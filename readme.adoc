...
image:https://img.shields.io/github/v/tag/Foxcapades/Argonaut?label=version&style=flat-square[GitHub tag (latest SemVer), link=https://github.com/Foxcapades/Argonaut/releases/latest]
