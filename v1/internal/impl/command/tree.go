...
func (_ tree) Name() string { return filepath.Base(os.Args[0]) }

func (_ tree) Parent() argo.CommandNode { return nil }
func (_ tree) HasParent() bool          { return false }

func (t tree) Description() string  { return t.description }
func (t tree) HasDescription() bool { return len(t.description) > 0 }

func (t tree) FlagGroups() []argo.FlagGroup { return t.flagGroups }
func (t *tree) HasFlagGroups() bool         { return len(t.flagGroups) > 0 }

func (t tree) CommandGroups() []argo.CommandGroup {
	return t.commandGroups
}

func (t tree) SelectedCommand() argo.CommandLeaf    { return t.selected }
func (t *tree) SelectCommand(leaf argo.CommandLeaf) { t.selected = leaf }

func (t tree) IsHelpDisabled() bool { return t.disableHelp }
